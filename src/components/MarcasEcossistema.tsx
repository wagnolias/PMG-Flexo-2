          ...
          <div id="pmg-flexo" className="rounded-3xl bg-slate-900 text-white border-2 border-pmg-magenta/40 p-8 sm:p-10 flex flex-col justify-between shadow-xl relative overflow-hidden">
            ...
            <div>
              ...
              <p className="text-slate-300 text-sm font-light leading-relaxed mb-6">
                Referência nacional em clichês em fotopolímero de alta definição. Laboratórios climatizados, tecnologias Everest® e Glaciar®, e operação 24 horas em Vinhedo-SP e Goiânia-GO.
              </p>
