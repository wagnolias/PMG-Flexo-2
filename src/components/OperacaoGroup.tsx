...
export const OperacaoGroup = () => {
  ...
  return (
    <section id="operacao" className="py-24 bg-slate-50 text-pmg-dark relative overflow-hidden border-b border-slate-200 scroll-mt-20">
      <div className="max-w-7xl mx-auto px-6 relative z-10">

        {/* Header */}
        <div className="max-w-2xl mx-auto text-center mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white border border-slate-200 text-xs font-semibold text-pmg-magenta uppercase tracking-wider mb-4">
            <Factory size={13} />
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          ...
          <div className="p-8 rounded-3xl bg-white border border-slate-200 shadow-sm text-center">
            <div className="w-12 h-12 rounded-2xl bg-pmg-magenta/10 text-pmg-magenta mx-auto flex items-center justify-center mb-4">
              <MapPin size={22} />
            </div>
            <div className="text-4xl font-black text-pmg-navy mb-1">02</div>
            <div className="text-xs font-bold text-pmg-magenta uppercase tracking-wider mb-2">Plantas de Gravação</div>
            <p className="text-xs text-slate-600 font-semibold">Goiânia - GO | Vinhedo - SP</p>
            <p className="text-[11px] text-slate-500 mt-2 font-light">Agilidade logística para Centro-Oeste, Sudeste, Sul e Norte.</p>
          </div>

          <div className="p-8 rounded-3xl bg-white border border-slate-200 shadow-sm text-center">
            <div className="w-12 h-12 rounded-2xl bg-blue-100 text-blue-600 mx-auto flex items-center justify-center mb-4">
              <Cpu size={22} />
            </div>
            <div className="text-4xl font-black text-pmg-navy mb-1">06</div>
            <div className="text-xs font-bold text-blue-600 uppercase tracking-wider mb-2">Gravadoras Digitais</div>
            <p className="text-xs text-slate-600 font-semibold">CDI Esko Pixel+ | HD Flexo Digital</p>
            <p className="text-[11px] text-slate-500 mt-2 font-light">Alta capacidade produtiva e redundância garantida.</p>
          </div>

          <div className="p-8 rounded-3xl bg-white border border-slate-200 shadow-sm text-center">
            <div className="w-12 h-12 rounded-2xl bg-emerald-100 text-emerald-600 mx-auto flex items-center justify-center mb-4">
              <Clock size={22} />
            </div>
            <div className="text-4xl font-black text-pmg-navy mb-1">24h</div>
            <div className="text-xs font-bold text-emerald-600 uppercase tracking-wider mb-2">Operação Contínua</div>
            <p className="text-xs text-slate-600 font-semibold">Segunda a Sexta-feira*</p>
            <p className="text-[11px] text-slate-500 mt-2 font-light">*Gravação ininterrupta na planta de Vinhedo-SP.</p>
          </div>
        ...
        <div className="mb-16">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 gap-4">
            <div>
              ...
              <h3 className="text-2xl sm:text-3xl font-extrabold text-pmg-navy">Nossas Instalações & Produção</h3>
            </div>
            <p className="text-xs sm:text-sm text-slate-500 max-w-md font-light">
        ...
        <div className="p-6 sm:p-8 rounded-3xl bg-white border border-slate-200 shadow-sm">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-xs font-bold uppercase tracking-widest text-slate-500">Softwares Gráficos Homologados</span>
          </div>

          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            {softwares.map((sw, i) => (
              <div key={i} className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 text-center">
                <div className="text-xs font-bold text-pmg-navy mb-0.5">{sw.name}</div>
                <div className="text-[10px] text-slate-500">{sw.role}</div>
              </div>
            ))}
          </div>
        </div>
