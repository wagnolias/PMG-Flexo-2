    ...
    <section id="cliches" className="py-24 bg-slate-50 text-pmg-dark relative overflow-hidden border-b border-slate-200 scroll-mt-20">
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          ...
          {/* 1. EVEREST */}
          <div className="rounded-3xl bg-white border border-slate-200 shadow-sm p-8 flex flex-col justify-between hover:border-pmg-magenta/50 transition-all">
            <div>
              <div className="flex items-center justify-between mb-6">
                <div className="w-12 h-12 rounded-2xl bg-pmg-magenta/10 text-pmg-magenta flex items-center justify-center font-black">
                  <Layers size={22} />
                </div>
              ...
              <h3 className="text-2xl font-bold text-pmg-navy mb-1">Everest<span className="text-pmg-magenta">®</span></h3>
            ...
            <div className="pt-4 border-t border-slate-200 text-center">
              <span className="text-xs font-semibold text-slate-500">Padrão Rotogravura na Flexografia</span>
            </div>
          </div>
          ...
          <div className="rounded-3xl bg-white border border-slate-200 shadow-sm p-8 flex flex-col justify-between hover:border-blue-300 transition-all">
            <div>
              ...
              <h3 className="text-2xl font-bold text-pmg-navy mb-1">Glaciar<span className="text-blue-600">®</span></h3>
              <div className="text-xs font-semibold text-blue-600 mb-4">Solução Exclusiva para Tinta Branca</div>
            ...
            <div className="pt-4 border-t border-slate-200 text-center">
              <span className="text-xs font-semibold text-blue-600">Máxima Cobertura e Economia</span>
            </div>
          </div>
          ...
          <div className="rounded-3xl bg-white border border-slate-200 shadow-sm p-8 flex flex-col justify-between hover:border-emerald-300 transition-all">
            <div>
              ...
              <h3 className="text-2xl font-bold text-pmg-navy mb-1">Provas Contratuais GMG</h3>
        ...
        {/* Technical Partners */}
        <div className="py-6 border-t border-slate-200 flex flex-wrap items-center justify-between gap-6 text-xs text-slate-500">
          <span className="font-semibold uppercase tracking-wider">Parceiros Globais Homologados:</span>
          <div className="flex flex-wrap items-center gap-6 font-bold text-slate-600">
            <span>DUPONT™</span>
            <span>MacDermid</span>
            <span>ESKO</span>
            <span>GMG Color</span>
