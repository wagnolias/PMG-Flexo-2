            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-sm">Garantir que sua equipe aproveite 100% do potencial da nossa plataforma de gravação, reduzindo setups e eliminando o improviso em máquina.</p>
                </div>
              </div>
              <div className="flex gap-4">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-3.5">
              {[
                ...
                { title: "Plataforma de Gravação & Reticulagem", desc: "Domínio das retículas de topo plano Everest® e K2® para degradês perfeitos e alta velocidade." },
